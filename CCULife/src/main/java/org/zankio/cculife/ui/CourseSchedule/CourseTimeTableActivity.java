...
public class CourseTimeTableActivity extends BaseFragmentActivity implements ActionBar.OnNavigationListener {
    ...
    public Kiki.TimeTable timeTable;
    private Kiki courseTimeTable;
    private TimeTableWeekPage timeTableWeekPage;
    private TimeTableDayPage timeTableDayPage;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch (layout) {
                ...
                case R.layout.fragment_course_timetable_day:
                    return (timeTableDayPage = new TimeTableDayPage(inflater, getSupportFragmentManager(), timeTable)).getView();
            }
