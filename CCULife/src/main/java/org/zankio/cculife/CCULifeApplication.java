...
public class CCULifeApplication extends Application {
    ...
    public void onCreate() {
        ...
        trustManager = Net.generateTrustManagers(this, "taiwanbus.crt");
        HTTPSource.trustManager.put("www.taiwanbus.tw", trustManager);
        HTTPSource.sslSocketFactory.put("www.taiwanbus.tw", Net.generateSSLSocketFactory(trustManager));
    }
}
